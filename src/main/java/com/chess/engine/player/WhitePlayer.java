...
public class WhitePlayer extends Player {
    public WhitePlayer(final Board board,
            final Collection<Move> whiteStandardLegelMoves,
            final Collection<Move> blackStandardLegelMoves) {
        super(board, whiteStandardLegelMoves, blackStandardLegelMoves);
    }
    ...
    protected Collection<Move> calculateKingCastles(final Collection<Move> playerLegals,
        ...
        if (this.playerKing.isFirstMove() && !this.isInCheck()) {
            if (!this.board.getTile(61).isTileOccupied() && !this.board.getTile(63).isTileOccupied()) {
